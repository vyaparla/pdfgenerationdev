  ...
  private
    ...
    def draw_containment_tent_used(pdf)
      ...
      if array.length >= 5
        if @project.m_servicetype == "Firedoor Inspection"
          ...
          pdf.font_size 12
          pdf.text_box("Containment Tent Used?", :at => [10, 335], :style => :bold)
          pdf.font_size 10
          if @project.m_containment_tent_used == "Yes"
            pdf.text_box("Y", :at => [315, 335])
          elsif @project.m_containment_tent_used == "No"
            pdf.text_box("N", :at => [315, 334])
          else
            pdf.text_box("NA", :at => [315, 335])
          end
        ...
        if @project.m_servicetype == "Firedoor Inspection"
          ...
          pdf.font_size 12
          pdf.text_box("Containment Tent Used?", :at => [10, 348], :style => :bold)
          pdf.font_size 10
          if @project.m_containment_tent_used == "Yes"
            pdf.text_box("Y", :at => [315, 348])
          elsif @project.m_containment_tent_used == "No"
            pdf.text_box("N", :at => [315, 348])
          else
            pdf.text_box("NA", :at => [315, 348])
          end
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.font_size 12
          pdf.text_box("Containment Tent Used?", :at => [10, 348], :style => :bold)
        ...
        if @project.m_servicetype == "Firedoor Inspection"
          ...
          pdf.font_size 12
          pdf.text_box("Containment Tent Used?", :at => [10, 360], :style => :bold)
          pdf.font_size 10
          if @project.m_containment_tent_used == "Yes"
            pdf.text_box("Y", :at => [315, 360])
          elsif @project.m_containment_tent_used == "No"
            pdf.text_box("N", :at => [315, 360])
          else
            pdf.text_box("NA", :at => [315, 360])
          end
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.font_size 12
          pdf.text_box("Containment Tent Used?", :at => [10, 360], :style => :bold)
    ...
    def draw_date(pdf)
      ...
      if array.length >= 5
        if @project.m_servicetype == "Firedoor Inspection"
          ...
          pdf.font_size 12
          pdf.text_box("Date", :at => [10, 310], :style => :bold)
          pdf.font_size 10
          pdf.text_box("#{@project.m_date.localtime.strftime(I18n.t('time.formats.mdY'))}", :at => [315, 310])
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.font_size 12
          pdf.text_box("Date", :at => [10, 310], :style => :bold)
          pdf.font_size 10
        ...
        if @project.m_servicetype == "Firedoor Inspection"
          ...
          pdf.font_size 12
          pdf.text_box("Date", :at => [10, 323], :style => :bold)
          pdf.font_size 10
          pdf.text_box("#{@project.m_date.localtime.strftime(I18n.t('time.formats.mdY'))}", :at => [315, 323])
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.font_size 12
          pdf.text_box("Date", :at => [10, 323], :style => :bold)
          pdf.font_size 10
        ...
        if @project.m_servicetype == "Firedoor Inspection"
          ...
          pdf.font_size 12
          pdf.text_box("Date", :at => [10, 335], :style => :bold)
          pdf.font_size 10
          pdf.text_box("#{@project.m_date.localtime.strftime(I18n.t('time.formats.mdY'))}", :at => [315, 335])
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.font_size 12
          pdf.text_box("Date", :at => [10, 335], :style => :bold)
          pdf.font_size 10
    ...
    def draw_tech_name(pdf)
      ...
      if array.length >= 5
        if @project.m_servicetype == "Firedoor Inspection"
          pdf.font_size 12
          pdf.text_box("Name", :at => [10, 186], :style => :bold)
          pdf.font_size 10
        ...
        if @project.m_servicetype == "Firedoor Inspection"
          pdf.font_size 12
          pdf.text_box("Name", :at => [10, 199], :style => :bold)
          pdf.font_size 10
          pdf.text_box("#{@project.m_technician_name}", :at => [315, 199])
        elsif @project.m_servicetype == "Firestop Survey"
          pdf.font_size 12
          pdf.text_box("Name", :at => [10, 305], :style => :bold)
          pdf.font_size 10
          pdf.text_box("#{@project.m_technician_name}", :at => [315, 305])
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.font_size 12
          pdf.text_box("Name", :at => [10, 305], :style => :bold)
          pdf.font_size 10
          ...
          #pdf.text_box("Name", :at => [10, 154], :style => :bold)
          pdf.text_box("Name", :at => [10, 167], :style => :bold)
          pdf.font_size 10
        ...
        if @project.m_servicetype == "Firedoor Inspection"
          pdf.font_size 12
          pdf.text_box("Name", :at => [10, 208], :style => :bold)
          pdf.font_size 10
          pdf.text_box("#{@project.m_technician_name}", :at => [315, 208])
        elsif @project.m_servicetype == "Firestop Survey"
          pdf.font_size 12
          pdf.text_box("Name", :at => [10, 317], :style => :bold)
          pdf.font_size 10
          pdf.text_box("#{@project.m_technician_name}", :at => [315, 317])
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.font_size 12
          pdf.text_box("Name", :at => [10, 317], :style => :bold)
          pdf.font_size 10
    ...
    def draw_signature(pdf)
      ...
      if array.length >= 5
        if @project.m_servicetype == "Firedoor Inspection"
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 141])
          image = @project.m_authorization_signature.path
          unless image.blank?
            pdf.image(image, at: [315, 166], :width => 150, :height => 70)
          else
          end
        elsif @project.m_servicetype == "Firestop Survey"
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 247])
          image = @project.m_authorization_signature.path
          unless image.blank?
          ...
          unless image.blank?
            ...
            pdf.image(image, at: [315, 134], :width => 150, :height => 60) #new
          else
          end
        end        
      elsif array.length == 3
        if @project.m_servicetype == "Firedoor Inspection"
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 154])
          image = @project.m_authorization_signature.path
          unless image.blank?
            pdf.image(image, at: [315, 179], :width => 150, :height => 70)
          else
          end
        elsif @project.m_servicetype == "Firestop Survey"
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 260])
          image = @project.m_authorization_signature.path
          unless image.blank?
            pdf.image(image, at: [315, 285], :width => 150, :height => 70)
          else
          end
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 260])
          ...
          #pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 109])
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 122])
          image = @project.m_authorization_signature.path
          unless image.blank?
            #pdf.image(image, at: [315, 164], :width => 150, :height => 70)
            #pdf.image(image, at: [315, 134], :width => 150, :height => 70)
            pdf.image(image, at: [315, 147], :width => 150, :height => 60)
          else
          end
        end        
      else
        if @project.m_servicetype == "Firedoor Inspection"
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 163])
          image = @project.m_authorization_signature.path
          unless image.blank?
            pdf.image(image, at: [315, 188], :width => 150, :height => 70)
          else
          end
        elsif @project.m_servicetype == "Firestop Survey"
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 272])
          image = @project.m_authorization_signature.path
          unless image.blank?
            pdf.image(image, at: [315, 297], :width => 150, :height => 70)
          else
          end
        elsif @project.m_servicetype == "Firestop Installation"
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 272])
          ...
          pdf.text_box("Authorization to inspect all dampers to completion", :at => [10, 126])
          image = @project.m_authorization_signature.path
          unless image.blank?
            #pdf.image(image, at: [315, 176], :width => 150, :height => 70)
            pdf.image(image, at: [315, 151], :width => 150, :height => 60)
          else
          end
        end
      end
