module FSSProjectCompletionReport
  class ProjectCompletionDetailPage
    ...
    def write(pdf)
      draw_pc_total_firestops_assets(pdf)
  ...
  private
    ...
    def draw_pc_total_firestops_assets(pdf)
    ...
    def draw_pc_total_firestops_surveyed(pdf)
      ...
      if array.length >= 5
        ...
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firestop_surveyed}", :at => [315, 350])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Firestop Surveyed:", :at => [10, 363], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firestop_surveyed}", :at => [315, 363])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Firestop Surveyed:", :at => [10, 375], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firestop_surveyed}", :at => [315, 375])
      end
    end
    ...
    def draw_pc_total_firestops_fixedonsite(pdf)
      ...
      if array.length >= 5
        ...
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firestop_fixedonsite}", :at => [315, 335])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Firestop Fixed on Site:", :at => [10, 348], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firestop_fixedonsite}", :at => [315, 348])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Firestop Fixed on Site:", :at => [10, 360], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firestop_fixedonsite}", :at => [315, 360])
      end
    end
  end
end