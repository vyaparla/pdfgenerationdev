module FDIProjectCompletionReport
  ...
  private
    ...
    def draw_pc_total_firedoor_inspected(pdf)
      ...
      if array.length >= 5
        pdf.font_size 12      
        pdf.text_box("Total # of Firedoors Inspected:", :at => [10, 365], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firedoor_inspected}", :at => [315, 365])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Firedoors Inspected:", :at => [10, 378], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firedoor_inspected}", :at => [315, 378])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Firedoors Inspected:", :at => [10, 390], :style => :bold)
        pdf.font_size 10
    ...
    def draw_pc_total_firedoor_conformed(pdf)
      ...
      if array.length >= 5
        pdf.font_size 12        
        pdf.text_box("Total # of Firedoors Conformed:", :at => [10, 350], :style => :bold)
        pdf.font_size 10        
        pdf.text_box("#{@project.m_total_no_of_firedoor_conformed}", :at => [315, 350])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Firedoors Conformed:", :at => [10, 363], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firedoor_conformed}", :at => [315, 363])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Firedoors Conformed:", :at => [10, 375], :style => :bold)
        pdf.font_size 10
    ...
    def draw_pc_total_firedoor_nonconformed(pdf)
      ...
      if array.length >= 5
        pdf.font_size 12
        pdf.text_box("Total # of Firedoors Nonconformed:", :at => [10, 335], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firedoor_nonconformed}", :at => [315, 335])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Firedoors Nonconformed:", :at => [10, 348], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_firedoor_nonconformed}", :at => [315, 348])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Firedoors Nonconformed:", :at => [10, 360], :style => :bold)
        pdf.font_size 10
