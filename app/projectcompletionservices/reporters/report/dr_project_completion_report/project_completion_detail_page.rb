module DRProjectCompletionReport
  ...
  private
    ...
    def draw_pc_total_damper_repaired(pdf)
      ...
      if array.length >= 5
        pdf.font_size 12
        pdf.text_box("Total # of Dampers Repair:", :at => [10, 347], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dampers_repaired}", :at => [315, 347])
      elsif array.length == 3
      	pdf.font_size 12
        pdf.text_box("Total # of Dampers Repair:", :at => [10, 360], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dampers_repaired}", :at => [315, 360])
      else
      	pdf.font_size 12
        pdf.text_box("Total # of Dampers Repair:", :at => [10, 372], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dampers_repaired}", :at => [315, 372])
      end
    end
    ...
    def draw_pc_total_damperrepaired(pdf)
      ...
      if array.length >= 5
        pdf.font_size 12
        pdf.text_box("Total # of Dampers Repaired:", :at => [10, 332], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dampersrepaired}", :at => [315, 332])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Dampers Repaired:", :at => [10, 345], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dampersrepaired}", :at => [315, 345])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Dampers Repaired:", :at => [10, 357], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dampersrepaired}", :at => [315, 357])
      end
    end
    ...
    def draw_pc_total_dr_access_door_installed(pdf)
      ...
      if array.length >= 5
        ...
        pdf.text_box("Total # of Access Doors Installed:", :at => [10, 317], :style => :bold)
        pdf.font_size 10
        ...
        pdf.text_box("#{@project.m_total_no_of_dr_access_door_installed}", :at => [315, 317])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Access Doors Installed:", :at => [10, 330], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dr_access_door_installed}", :at => [315, 330])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Access Doors Installed:", :at => [10, 342], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dr_access_door_installed}", :at => [315, 342])
      end	
    end
    ...
    def draw_pc_total_dr_actuator_installed(pdf)
      ...
      if array.length >= 5
        ...
        pdf.text_box("Total # of Actuators Installed:", :at => [10, 302], :style => :bold)
        pdf.font_size 10
        ...
        pdf.text_box("#{@project.m_total_no_of_dr_actuator_installed}", :at => [315, 302])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Actuators Installed:", :at => [10, 315], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dr_actuator_installed}", :at => [315, 315])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Actuators Installed:", :at => [10, 327], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dr_actuator_installed}", :at => [315, 327])
      end
    end
    ...
    def draw_pc_total_dr_damper_installed(pdf)
      ...
      if array.length >= 5
        ...
        pdf.text_box("Total # of Dampers Installed:", :at => [10, 287], :style => :bold)
        pdf.font_size 10
        ...
        pdf.text_box("#{@project.m_total_no_of_dr_damper_installed}", :at => [315, 287])
      elsif array.length == 3
        pdf.font_size 12
        pdf.text_box("Total # of Dampers Installed:", :at => [10, 300], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dr_damper_installed}", :at => [315, 300])
      else
        pdf.font_size 12
        pdf.text_box("Total # of Dampers Installed:", :at => [10, 312], :style => :bold)
        pdf.font_size 10
        pdf.text_box("#{@project.m_total_no_of_dr_damper_installed}", :at => [315, 312])
      end	
    end
